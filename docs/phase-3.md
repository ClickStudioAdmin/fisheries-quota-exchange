...
- Server actions in `lib/auth/actions.ts` handle register, login, logout, password reset, and signed-in updates (name, email, phone on Account details → Profile; password on Password and security).
