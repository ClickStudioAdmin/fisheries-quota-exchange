...
| `/dashboard/profile` | Profile: Details, Password and Security, Notifications, and Alerts |
| `/dashboard/account` | Account Settings: Details, Members, Payments, and Notifications (role routing and account message list) |
