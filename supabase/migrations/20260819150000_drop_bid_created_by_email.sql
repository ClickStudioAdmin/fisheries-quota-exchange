-- Reverse 20260819140000_bid_created_by_email. That file was applied on
-- development, then deleted from git, which broke supabase db push.
-- Keep the applied version in git and drop the column in a new migration.
