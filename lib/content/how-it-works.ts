export const HOW_IT_WORKS_BUYER_STEPS = [
  {
    ...
    body: "Register with your name, email, and phone. Confirm your email, then agree to the terms on Overview and add business details on Profile. Buying or winning an auction is a binding agreement to complete the trade. If you do not proceed, you still pay the platform commission.",
  },
  {
    title: "Find quota",
...
export const HOW_IT_WORKS_SELLER_STEPS = [
  {
    title: "Create an account",
    body: "Register with your name, email, and phone. Confirm your email, agree to the terms, add business details on Profile, then complete payments setup so FQX can pay you at settlement. Listing quota is a binding offer. If a buyer commits and you do not proceed, you still pay the platform commission.",
  },
  {
